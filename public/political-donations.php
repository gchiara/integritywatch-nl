        ...
        <div class="row dashboard-container">
          ...
          <div class="col-md-12 chart-col">
            <div class="toggle-mps-container-mobile">
              <button class="toggle-mps-btn">Zonder kamerleden</button>
            </div>
          </div>
          <!-- CHARTS - FIRST ROW -->
          <div class="col-md-4 chart-col">
            <div class="boxed-container chart-container tab_c_1">
              ...
              <div class="chart-notes">* Ook na het selecteren van “zonder Kamerleden” blijft het bedrag aan donaties voor de SP erg hoog. Dit is omdat de SP al haar volksvertegenwoordigers en bestuurders (dus ook raadsleden, statenleden, wethouders etc.) verplicht om een groot deel van het salaris aan de partij af te dragen.</div>
            </div>
          </div>
          <div class="col-md-4 chart-col">
