...
var agendasDataFile = './data/agendas.csv';
...
csv(agendasDataFile, (err, events) => {
  csv(ministriesMatchingFile, (err, ministriesMatching) => {
    ...
    _.each(events, function (d) {
      ...
      console.log(d.ministries);
    });

    //Set dc main vars. The second crossfilter is used to handle the travels stacked bar chart.
    var ndx = crossfilter(events);
    var searchDimension = ndx.dimension(function (d) {
        var entryString = d.activiteitnaam + ' ' + d.type + ' ' + d.bewindspersoon;
